...
extension Enzyme {
    ...
    //        let cleaveCharacters = characterClass(from: cleaveAt)
    //
    //        guard !cleaveCharacters.isEmpty else {
    //            return ""
    //        }
    //
    //        let blockedCharacters = characterClass(from: dontCleaveBefore)
    //
    //        let cleave = "[\(cleaveCharacters)]"
    //
    //        let notFollowedByBlocked =
    //            blockedCharacters.isEmpty
    //            ? ""
    //            : "(?![\(blockedCharacters)])"
    //
    //        let before = "(?=\(cleave)\(notFollowedByBlocked))"
    //        let after = "(?<=\(cleave))\(notFollowedByBlocked)"
    //
    //        switch (
    //            cleaveDirections.contains(.before),
    //            cleaveDirections.contains(.after)
    ...
    //    public func cutRanges(in input: String) throws -> [Range<Int>] {
    ...
    //
    //            if cleaveDirections.contains(.before) {
    //                cutPositions.insert(matchStart)
    //            }
    //
    //            if cleaveDirections.contains(.after),
    //                !afterCutIsBlocked
    //            {

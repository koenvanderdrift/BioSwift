...
//        else { return (0.0) }
//
//        let numberOfAsparticAcid = Double(symbolSet.count(for: "D"))
//        let numberOfGlutamicAcid = Double(symbolSet.count(for: "E"))
//        let numberOfCysteine = Double(symbolSet.count(for: "C"))
//        let numberOfTyrosine = Double(symbolSet.count(for: "Y"))
//        let numberOfHistidine = Double(symbolSet.count(for: "H"))
//        let numberOfLysine = Double(symbolSet.count(for: "K"))
//        let numberOfArginine = Double(symbolSet.count(for: "R"))
//
...
//            asparticAcidCharge = -(numberOfAsparticAcid / (1 + pow(10, asparticAcidpKa - pH)))
//            glutamicAcidCharge = -(numberOfGlutamicAcid / (1 + pow(10, glutamicAcidpKa - pH)))
//            cysteineCharge = -(numberOfCysteine / (1 + pow(10, cystinepKa - pH)))
//            tyrosineCharge = -(numberOfTyrosine / (1 + pow(10, tyrosinepKa - pH)))
//
//            nTerminalCharge = 1 / (1 + pow(10, pH - nTerminalpKa))
//            histidineCharge = numberOfHistidine / (1 + pow(10, pH - histidinepKa))
//            lysineCharge = numberOfLysine / (1 + pow(10, pH - lysinepKa))
//            arginineCharge = numberOfArginine / (1 + pow(10, pH - argininepKa))
//
